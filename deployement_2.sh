...
mysql -u$PRO_USERID --port $PRO_PORT  -p$PRO_PASSWORD -c -h $PROD_IPADDRESS -e "select * from xfusion_config.version_status where project_name='$ORGANIZATION' and model_name='$APPLICATION' order by script_date;"
